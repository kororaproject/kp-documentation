...
#### Autologin Greeter
In the repos is a package called lightdm-autologin-greeter. This is not designed for the general user. It provides a permanent autologin without access to the login screen. If a user logs out it will immediately log the default user back in. This package is designed for kiosk use.

<a name="additional-steps-for-mate"></a>
